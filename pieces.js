...
const avis_js_1 = require("./avis.js");
(0, avis_js_1.ajoutListenerEnvoyerAvis)();
...
const genererPieces = (pieces) => {
    ...
    for (let i = 0; i < pieces.length; i++) {
        ...
        categorieElement.innerText = (_a = article.categorie) !== null && _a !== void 0 ? _a : "(aucune catégorie)";
        const descriptionElement = document.createElement("p");
        descriptionElement.innerText = (_b = article.description) !== null && _b !== void 0 ? _b : "Pas de description pour le moment.";
    ...
    (0, avis_js_1.ajoutListenersAvis)();
};
...
for (let i = 0; i < pieces.length; i++) {
    ...
    if (avis !== null) {
        ...
        (0, avis_js_1.afficherAvis)(pieceElement, avis);
    }
}
...
(0, avis_js_1.afficherGraphiqueAvis)();
