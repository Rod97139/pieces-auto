...
var _avisTs = require("./avis.ts");
(0, _avisTs.ajoutListenerEnvoyerAvis)();
...
const fetchData = async ()=>{
    if (pieces === null) {
        /* Code de récupération des pièces depuis l’API HTTP */ pieces = await fetch("http://localhost:8081/pieces").then((pieces)=>pieces.json());
...
for(let i = 0; i < pieces.length; i++){
    ...
    if (avis !== null) {
        ...
        (0, _avisTs.afficherAvis)(pieceElement, avis);
    }
}
...
(0, _avisTs.afficherGraphiqueAvis)();

},{"./avis.ts":"ghwCf"}],"ghwCf":[function(require,module,exports) {
/* global Chart */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ajoutListenersAvis", ()=>ajoutListenersAvis);
parcelHelpers.export(exports, "afficherAvis", ()=>afficherAvis);
parcelHelpers.export(exports, "ajoutListenerEnvoyerAvis", ()=>ajoutListenerEnvoyerAvis);
parcelHelpers.export(exports, "afficherGraphiqueAvis", ()=>afficherGraphiqueAvis);
...
const afficherGraphiqueAvis = async ()=>{
